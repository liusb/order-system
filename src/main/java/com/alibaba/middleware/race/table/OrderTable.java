...
//    private static final int REOPEN_BUYER_INDEX_CACHE_SIZE = 16;
    ...
    private static final int TABLE_BUCKET_SIZE = 64*(1<<10);
    private static final int TABLE_CACHE_SIZE = 64*(1<<10);
    private static final int REOPEN_TABLE_CACHE_SIZE = 64*(1<<10);
    private static final int ORDER_INDEX_BUCKET_SIZE = 16*(1<<10);
    private static final int ORDER_INDEX_CACHE_SIZE = 16*(1<<10);
    private static final int REOPEN_ORDER_INDEX_CACHE_SIZE = 4*(1<<10);
    private static final int BUYER_INDEX_BUCKET_SIZE = 16*(1<<10);
    private static final int BUYER_INDEX_CACHE_SIZE = 16*(1<<10);
    private static final int REOPEN_BUYER_INDEX_CACHE_SIZE = 4*(1<<10);
    ...
    private static final int ORDER_INDEX_PAGE_SIZE = 8*(1<<10);  // 1KB
    // 索引为orderId 记录存储格式为[orderId, fileId, address](long, byte, long)
    public HashTable orderIndex;

    private static final int BUYER_INDEX_PAGE_SIZE = 8*(1<<10);
