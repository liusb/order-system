...
public class OrderTable {
    ...
    // 哈希桶的总个数
    private static final int TABLE_BUCKET_SIZE = 512;
    // 建立表示很LRU缓存的大小
    ...
    private static final int ORDER_INDEX_BUCKET_SIZE = 512;
    private static final int ORDER_INDEX_CACHE_SIZE = 256;
    ...
    private static final int BUYER_INDEX_BUCKET_SIZE = 512;
    private static final int BUYER_INDEX_CACHE_SIZE = 256;
...
//        orderIndexColumns.put("createtime", baseTable.getColumn("createtime"));
    ...
    public void reopen() {
        baseTable.reopen(TABLE_CACHE_SIZE);
        orderIndex.reopen(ORDER_INDEX_CACHE_SIZE);
        buyerCreateTimeIndex.reopen(BUYER_INDEX_CACHE_SIZE);
    }
