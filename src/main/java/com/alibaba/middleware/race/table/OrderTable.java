...
public class OrderTable {
    ...
    // 哈希桶的总个数
    private static final int TABLE_BUCKET_SIZE = 256;//256;
    // 建立表示很LRU缓存的大小
    private static final int TABLE_CACHE_SIZE = 128;//128;
    // 每页的大小，单位为byte
    ...
    private static final int ORDER_INDEX_BUCKET_SIZE = 256;//256;
    private static final int ORDER_INDEX_CACHE_SIZE = 128;//128;
    ...
    private static final int BUYER_INDEX_BUCKET_SIZE = 256;//256;
    private static final int BUYER_INDEX_CACHE_SIZE = 128;//128;
...
//        orderIndexColumns.put("createtime", baseTable.getColumn("createtime"));
    ...
    public void reopen() {
        baseTable.reopen(256);
        orderIndex.reopen(32);
        buyerCreateTimeIndex.reopen(32);
    }
