...
public class OrderTable {
    ...
    // 建立表示很LRU缓存的大小
    private static final int TABLE_CACHE_SIZE = 256;//128;
    // 每页的大小，单位为byte
    ...
    private static final int ORDER_INDEX_BUCKET_SIZE = 512;//256;
    private static final int ORDER_INDEX_CACHE_SIZE = 256;//128;
    ...
    private static final int BUYER_INDEX_BUCKET_SIZE = 512;//256;
    private static final int BUYER_INDEX_CACHE_SIZE = 256;//128;
