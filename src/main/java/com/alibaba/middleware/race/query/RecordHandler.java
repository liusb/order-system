...
public class RecordHandler implements CompletionHandler<Integer, RecordAttachment> {

    @Override
    public void completed(Integer result, RecordAttachment attachment) {
    ...
    @Override
    public void failed(Throwable exc, RecordAttachment attachment) {
